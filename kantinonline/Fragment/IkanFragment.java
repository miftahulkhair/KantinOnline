...
public class IkanFragment extends Fragment {
    ...
    private DatabaseReference rootRef,ikanRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FirebaseRecyclerAdapter<Menu, MenuViewHolder>(Menu.class,R.layout.recycler_item,MenuViewHolder.class,ikanRef) {
            @Override
