 ...
 */
public class NasiFragment extends Fragment {

    private FirebaseRecyclerAdapter<Menu,MenuViewHolder> mAdapter;
    private DatabaseReference rootRef,nasiRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FirebaseRecyclerAdapter<Menu, MenuViewHolder>(Menu.class,R.layout.recycler_item,MenuViewHolder.class,nasiRef) {
            @Override
